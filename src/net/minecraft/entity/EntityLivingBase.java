...
public abstract class EntityLivingBase extends Entity
{
    ...
    protected float applyArmorCalculations(DamageSource source, float damage)
    {
        if (!source.isUnblockable())
        {
            ...
            damage = CombatRules.func_189427_a(damage, (float)this.getTotalArmorValue(), (float)this.getEntityAttribute(SharedMonsterAttributes.field_189429_h).getAttributeValue());
        }
