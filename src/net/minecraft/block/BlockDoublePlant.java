...
public class BlockDoublePlant extends BlockBush implements IGrowable
{
    ...
    {
        if (worldIn.isRemote || stack == null || stack.getItem() != Items.SHEARS || state.getValue(HALF) != BlockDoublePlant.EnumBlockHalf.LOWER || !this.onHarvest(worldIn, pos, state, player))
        {
