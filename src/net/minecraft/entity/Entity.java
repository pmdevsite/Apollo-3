...
public abstract class Entity implements ICommandSender
{
    ...
    public boolean isWet()
    {
        ...
        else
        {
            ...
            if (!this.worldObj.isRainingAt(blockpos$pooledmutableblockpos) && !this.worldObj.isRainingAt(blockpos$pooledmutableblockpos.func_189532_c(this.posX, this.posY + (double)this.height, this.posZ)))
            {
                blockpos$pooledmutableblockpos.release();
                return false;
            }
