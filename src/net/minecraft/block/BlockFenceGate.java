...
public class BlockFenceGate extends BlockHorizontal
{
    ...
    public void func_189540_a(IBlockState p_189540_1_, World p_189540_2_, BlockPos p_189540_3_, Block p_189540_4_)
    {
        if (!p_189540_2_.isRemote)
        {
            ...
            {
                if (flag && !((Boolean)p_189540_1_.getValue(OPEN)).booleanValue() && !((Boolean)p_189540_1_.getValue(POWERED)).booleanValue())
                {
                ...
                else if (!flag && ((Boolean)p_189540_1_.getValue(OPEN)).booleanValue() && ((Boolean)p_189540_1_.getValue(POWERED)).booleanValue())
                {
                ...
                else if (flag != ((Boolean)p_189540_1_.getValue(POWERED)).booleanValue())
                {
