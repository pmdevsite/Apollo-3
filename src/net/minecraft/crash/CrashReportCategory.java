...
public class CrashReportCategory
{
    ...
    public static void addBlockInfo(CrashReportCategory category, final BlockPos pos, final Block blockIn, final int blockData)
    {
        ...
        category.func_189529_a("Block type", new ICrashReportDetail<String>()
        {
        ...
        category.func_189529_a("Block data value", new ICrashReportDetail<String>()
        {
            public String call() throws Exception
            {
                if (blockData < 0)
        ...
        category.func_189529_a("Block location", new ICrashReportDetail<String>()
        {
            public String call() throws Exception
            {
    ...
    {
        category.func_189529_a("Block", new ICrashReportDetail<String>()
        {
            public String call() throws Exception
            {
