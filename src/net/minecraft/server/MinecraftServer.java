...
public abstract class MinecraftServer implements Runnable, ICommandSender, IThreadListener, ISnooperInfo
{
    ...
    {
        report.getCategory().func_189529_a("Profiler Position", new ICrashReportDetail<String>()
        {
        ...
        if (this.playerList != null)
        {
            report.getCategory().func_189529_a("Player Count", new ICrashReportDetail<String>()
            {
                public String call()
                {
