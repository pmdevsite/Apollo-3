...
public class WorldInfo
{
    ...
    {
        category.func_189529_a("Level seed", new ICrashReportDetail<String>()
        {
        ...
        category.func_189529_a("Level generator", new ICrashReportDetail<String>()
        {
            public String call() throws Exception
            {
        ...
        category.func_189529_a("Level generator options", new ICrashReportDetail<String>()
        {
            public String call() throws Exception
            {
        ...
        category.func_189529_a("Level spawn location", new ICrashReportDetail<String>()
        {
            public String call() throws Exception
            {
        ...
        category.func_189529_a("Level time", new ICrashReportDetail<String>()
        {
            public String call() throws Exception
            {
        ...
        category.func_189529_a("Level dimension", new ICrashReportDetail<String>()
        {
            public String call() throws Exception
            {
        ...
        category.func_189529_a("Level storage version", new ICrashReportDetail<String>()
        {
            public String call() throws Exception
            {
                String s = "Unknown?";
        ...
        category.func_189529_a("Level weather", new ICrashReportDetail<String>()
        {
            public String call() throws Exception
            {
        ...
        category.func_189529_a("Level game mode", new ICrashReportDetail<String>()
        {
            public String call() throws Exception
            {
